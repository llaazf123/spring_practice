...
<body>
	...
	<%
		try {
			ExamService examService = new ExamServiceImpl();	//ExamService의 selectAll 메서드를 실행 - 실행한 뒤 ExamSIO형태의 list 변수에 값을 저장
	...
	<%      
    	for(int i=0; i<exams.size();i++){
            ...
            out.println("<td width=50><p align=center>"+
                    "<a href='oneviewDB.jsp?studentid="+Integer.toString(exams.get(i).getStudentid())+"'>"+	//exams에 저장되어 있는 값들을 꺼내옴
